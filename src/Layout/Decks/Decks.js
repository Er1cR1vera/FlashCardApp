...
function Decks() {
    ...
    const deleteHandler = async () => {
        if (
            window.confirm(
                "Deleting this card is irreversible. Continue?"
            )
        ) {
            await deleteDeck(id);
            history.push("/");
            ...
            <div className="col-9 mx-auto">
                ...
                <div className="card border-0 mb-4">
                    <div className="card-body">
                        ...
                        <p className="cars-text">{description}</p>
                        ...
                        <div className="row px-3">
                            ...
                            <Link to={`/decks/${id}/cards/new`} className="btn btn-primary ml-3">
                            ...
                            <div className="card">
                                ...
                                <div className="d-flex justify-content-end p-4">
                                    ...
                                    onClick={async () => {
                                        if (
                                            window.confirm(
                                                "Deleting is irreversible!! Continue?"
                                            )
                                        ) {
